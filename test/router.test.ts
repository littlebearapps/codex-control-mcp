...
describe("Router - Routing Logic", () => {
  ...
  test("Handles execution errors gracefully", async () => {
    ...
    const mockTool = new MockPrimitiveTool(createMockSchema(), async () => {
      ...
      alternatives: [
        {
          ...
          confidence: 45,
          extractedParams: {},
          reasoning: "Matched keyword A",
        },
        {
          primitive: "_option2",
          confidence: 40,
          extractedParams: {},
          reasoning: "Matched keyword B",
        },
      ],
      requiresDisambiguation: false,
...
describe("Router - Edge Cases", () => {
  ...
  test("Lists all registered primitives", () => {
    ...
    router.registerPrimitive(
      "_primitive1",
      new MockPrimitiveTool(createMockSchema()),
    );
    router.registerPrimitive(
      "_primitive2",
      new MockPrimitiveTool(createMockSchema()),
  ...
  test("Allows duplicate primitive registration (overwrites)", () => {
    ...
    const tool1 = new MockPrimitiveTool(createMockSchema(), async () => ({
      version: 1,
    }));
    const tool2 = new MockPrimitiveTool(createMockSchema(), async () => ({
      version: 2,
    }));

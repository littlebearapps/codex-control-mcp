  ...
  private setupHandlers() {
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      try {
        switch (name) {
          case 'codex_cli_run':
            return await this.runTool.execute(args as any) as any;

          case 'codex_cli_plan':
            return await this.planTool.execute(args as any) as any;

          case 'codex_cli_apply':
            return await this.applyTool.execute(args as any) as any;

          case 'codex_cli_status':
            return await this.statusTool.execute(args as any) as any;
          ...
          case 'codex_cloud_list_tasks':
            return await this.cloudListTasksTool.execute(args as any) as any;
          ...
          case 'codex_cloud_check_reminder':
            return await this.cloudCheckReminderTool.execute() as any;

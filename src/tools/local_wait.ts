      ...
      inputSchema: {
        ...
        properties: {
          ...
          timeout_sec: {
            type: 'number',
            description:
              'Max seconds to wait (default: 300, i.e., 5 minutes). Server caps this at 10 minutes.',
          },
          poll_interval_sec: {
            type: 'number',
            description:
              'Initial polling interval in seconds (default: 2). Server adjusts with backoff.',
          },
        },
        required: ['task_id'],
      },

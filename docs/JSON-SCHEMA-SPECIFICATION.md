...
interface WaitResultData {
  ...
  artifacts?: Array<{ type: string; ref: string; size: number; sha256?: string }>;
  output?: {
    included: boolean;
    stdout?: string;
    stderr?: string;
...
```json
{
  ...
  "type": "object",
  "required": ["version", "schema_id", "tool", "tool_category", "request_id", "ts", "status"],
  "properties": {
...
console.log(`📁 Modified: ${result.data.metadata.file_operations.modified_files.length} files`);

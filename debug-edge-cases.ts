...
const testCases = [
  ...
  {
    input: "Execute a comprehensive security audit",
    expected: "_codex_local_exec",
  },
  {
    input: "Keep working on that refactoring",
    expected: "_codex_local_resume",
  },
  { input: "Show me what completed", expected: "_codex_local_results" },
  {
    input: "Run tests in background and create PR if passing",
    expected: "_codex_cloud_submit",
  },
  { input: "Show cloud tasks", expected: "_codex_cloud_status" },
  {
    input: "Show me the PR that was created",

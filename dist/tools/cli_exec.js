...
export class CliExecTool {
    ...
    static getSchema() {
        return {
            name: 'codex_cli_exec',
            description: 'Execute Codex tasks via CLI with unified mode control. Supports read-only analysis, preview/planning, and file mutations (with confirmation). Consolidates previous codex_cli_run, codex_cli_plan, and codex_cli_apply into one tool.',
            inputSchema: {
                type: 'object',
                properties: {
                    task: {

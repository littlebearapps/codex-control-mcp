...
const LocalExecInputSchema = z.object({
    ...
    mode: z
        ...
        .optional()
        .default("read-only")
        .describe("Execution mode: read-only (safe), workspace-write (can edit files), danger-full-access (unrestricted)"),
    outputSchema: z
        .any()
        .optional()
    ...
    allow_destructive_git: z
        ...
        .optional()
        .default(false)
        .describe("Allow risky git operations (rebase, reset --hard, force push, etc.). User must explicitly confirm via Claude Code dialog."),
    format: z
        .enum(["json", "markdown"])
        .optional()
        .default("markdown")

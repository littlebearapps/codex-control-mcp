...
export class ApplyTool {
    ...
    static getSchema() {
        return {
            ...
            description: 'Execute a local Codex task via CLI that modifies files. REQUIRES confirm=true to prevent accidental changes. Use codex_cli_plan first to preview.',
            inputSchema: {
                type: 'object',
                properties: {
                    task: {

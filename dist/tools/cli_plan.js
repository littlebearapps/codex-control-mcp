...
export class PlanTool {
    ...
    static getSchema() {
        return {
            name: 'codex_cli_plan',
            description: 'Preview what local Codex CLI would do for a task without executing it. Shows proposed file changes and commands.',
            inputSchema: {
                type: 'object',
                properties: {
                    task: {
...
//# sourceMappingURL=cli_plan.js.map
...
export class SafetyCheckpointing {
     ...
     */
    sanitizeOperationName(operation) {
        return operation
            .toLowerCase()
     ...
     */
    async createCheckpoint(operation, workingDir) {
     ...
     */
    logCheckpoint(checkpoint, operation, workingDir) {
        try {
     ...
     */
    formatRecoveryInstructions(checkpoint) {
     ...
     */
    async cleanupOldCheckpoints(workingDir, daysToKeep = 30) {
        try {
...
//# sourceMappingURL=safety_checkpointing.js.map